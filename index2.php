	...
	<div id="container">
		...
		<div id="panel">
			...
			<div style="float:left; width:50%; position:relative;">
				...
				<br />
				<span style="position:relative; left:7px;">Mi Progreso</span>
				</div>
				</a>
			</div>
			<div style="float:left; width:50%;  position:relative;">
				...
				<br />
				<span style="position:relative; left:12px;">Mi Método <br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;KOT</span>
				</div>
				</a>
			</div>
			...
			<div style="float:left; width:50%; position:relative;">
				...
				<br />
				<span style="position:relative; left:15px;"> Restaurantes </span>
				</div>
				</a>
			</div>
			<div style="float:left; width:50%; position:relative;">
				...
				<br />
				<span>Alimentos <br /> Permitidos</span>
				</div>
				</a>
			</div>
